...
public class ParameterFactory {
    ...
    public ParameterFactory(Builder builder) {
        ...
        //通过方法参数体构建方法体: public void loadParameter(Object object){
        methodBuilder=MethodSpec.methodBuilder(PARAMETER_METHOD_NAME)
    ...
    /**
     * 构建防范内容，如： t.s=t.getIntent.getStringExtra("s");
    ...
    public void buildStatement(Element element){
        ...
        //判断注解的值为空的情况下处理（注解中有name的值就用注解值）
